...
function App() {
  ...
  return (
    ...
    <a class="navbar-brand" href="#"><img src="logo-logomark.png" width="30" height="30" class="d-inline-block align-top" alt=""></img>
    Proyecto Firebase</a>
    ...
    <div className="container">
      <div className="row">
        <div className="col-md-6">
            <h3 class="text-light" className="text-center">Lista de Tareas</h3>
        ...
        <div className="col-md-6 text-center text-light">
            ...
            <form onSubmit={
              ...
              <button
                type='submit'
                className={
                  modoEdicion ? "btn btn-warning btn-block" : "btn btn-warning btn-block"
                }
              >{
